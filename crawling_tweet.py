...
ptm_terbatas = "D:/Kuliah/KRISPI/py/Analisis/data/data/datasetSource/tweet-dataset-ptmTerbatas2.csv"
...
def clean_tweets(tweet):
    ...
    my_file = open("D:/Kuliah/KRISPI/py/Analisis/cleaning_source/combined_stop_words.txt", "r") 
    content = my_file.read()
    stop_words = content.split("\n")
    file_2  = open("D:/Kuliah/KRISPI/py/Analisis/cleaning_source/update_combined_slang_words.txt", "r")
